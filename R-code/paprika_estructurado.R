...
plot_spectra(fullData, colorBy= cb, pg.fns="datita1")
selectWls(fullData, 1000, 1200)
plot_spectra(fullData, colorBy= cb, pg.fns="datita2")
...
cu
plot_pls(cu, pg.fns= "PLS_paprika")
